...
def build_photo_examples(face_filename, text_filename, example_filename_prefix, logger=None):
    print()
    photos_id = set()
    ...
    text_info_photos = set()  # {photo_id: string, features: []}
    ...
    store(example_filename_prefix + '.txt', embeddings.shape[1], photos_id, face_info, text_info_photos)
    store(example_filename_prefix + '-topic.txt', 1, photos_id, face_info, text_info_photos)
